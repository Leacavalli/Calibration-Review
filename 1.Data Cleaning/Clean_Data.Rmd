...
clean_data_V5.2_dirty <- clean_data_V5.2 |>
  ...
  mutate(Nature.of.calibration.results = c("Point estimate (single parameter / parameter set); Not reported ", "Sample estimate (multiple parameter sets)", "Point estimate (single parameter / parameter set); Not reported ", "Point estimate (single parameter / parameter set); Not reported ", "Sample estimate (multiple parameter sets)", "Sample estimate (multiple parameter sets)"))
# Finalize the data
