...
```{r}
# 0.3 Model type 
score_0.3 <- clean_data |> 
  mutate(Model.type = ifelse(Model.type=="Not reported", 0, 1))|> 
  select(Model.type) 

# 0.4 Stochasticity in model 
score_0.4 <- clean_data |> 
  mutate(Stochasticity.in.model = ifelse(Stochasticity.in.model=="Not reported", 0, 1))|> 
  select(Stochasticity.in.model) 
...
# score_C.5 <- clean_data |> 
#   mutate(What.programming.language.was.used.for.calibration. = ifelse(What.programming.language.was.used.for.calibration.=="Not reported", 0, 1))|> 
...
# score_C.6 <- clean_data |> 
#   mutate(Do.authors.list.any.programming.packages.used.for.calibration. = ifelse(Do.authors.list.any.programming.packages.used.for.calibration.=="Not reported", 0, 1))|> 
#   select(Do.authors.list.any.programming.packages.used.for.calibration.) 
```
