...
# Write a file 
library(xlsx)
write.xlsx(as.data.frame(Objective3_df), file="Data_extraction_sheet_v04.xlsx",
  sheetName = "Reporting", append=TRUE , row.names = F, col.names = T)
...
colSums((Objective3_df[,-c(1:3, ncol(Objective3_df))])) 

# Percentage articles reporting each category
round(100 * colSums(Objective3_df[,-c(1:3, ncol(Objective3_df))]) / nrow(Objective3_df))
